# WaterQualityArchive SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WaterQualityArchiveSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WaterQualityArchiveSDK(...) and WaterQualityArchiveSDK.test(...) become
#      WaterQualityArchiveSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "waterqualityarchive_sdk"
_SDK_CLASS = "WaterQualityArchiveSDK"
