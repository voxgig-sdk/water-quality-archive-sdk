...
The Python SDK for the WaterQualityArchive API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Measurement()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/water-quality-archive-sdk/releases)) or
...
```
py/
├── waterqualityarchive_sdk.py         -- Main SDK module
