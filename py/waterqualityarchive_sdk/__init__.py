...
from waterqualityarchive_sdk.utility import register

# Load features
from waterqualityarchive_sdk.feature.base_feature import WaterQualityArchiveBaseFeature
from waterqualityarchive_sdk.features import _has_feature, _make_feature
...
class WaterQualityArchiveSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WaterQualityArchiveUtility()
        self._utility = utility

        from waterqualityarchive_sdk.config import shared_config
    ...
    def get_utility(self):
        return WaterQualityArchiveUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WaterQualityArchiveSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Measurement(self, data=None) -> "MeasurementEntity":
        ...
        from waterqualityarchive_sdk.entity.measurement_entity import MeasurementEntity
