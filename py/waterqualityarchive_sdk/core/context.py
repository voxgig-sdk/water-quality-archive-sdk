...
from waterqualityarchive_sdk.core.control import WaterQualityArchiveControl
...
from waterqualityarchive_sdk.core.helpers import get_ctx_prop, to_map
...
class WaterQualityArchiveContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WaterQualityArchiveControl()
        ...
        if isinstance(sp, WaterQualityArchiveSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WaterQualityArchiveResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WaterQualityArchiveResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WaterQualityArchiveOperation({})
    ...
    def make_error(self, code, msg):
        return WaterQualityArchiveError(code, msg, self)
