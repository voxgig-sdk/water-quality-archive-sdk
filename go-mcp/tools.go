...
type Args struct {
	Entity string         `json:"entity" jsonschema:"measurement"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WaterQualityArchiveSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "water-quality-archive_list",
		Description: "List records from WaterQualityArchive. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "water-quality-archive_load",
		Description: "Load a single record from WaterQualityArchive. " +
...
func runOp(client *sdk.WaterQualityArchiveSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WaterQualityArchiveSDK, name string) (sdk.WaterQualityArchiveEntity, error) {
