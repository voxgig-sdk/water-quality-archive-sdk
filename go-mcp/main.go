// Command WaterQualityArchive-mcp is an MCP server exposing the WaterQualityArchive
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WaterQualityArchive_list  — list records of an entity
//	WaterQualityArchive_load  — load a single record of an entity
//
