# WaterQualityArchive SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # WaterQualityArchiveSDK.new, not WaterQualityArchiveSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    WaterQualityArchiveSDK.new(opts)
  end
