...
// WaterQualityArchive SDK audit feature
...
class WaterQualityArchiveAuditFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _emit(WaterQualityArchiveContext $ctx, string $outcome): void
    {
