...
// WaterQualityArchive SDK rbac feature
...
class WaterQualityArchiveRbacFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _required(WaterQualityArchiveContext $ctx): ?string
    {
    ...
    private function _reject(WaterQualityArchiveContext $ctx, string $required): void
    {
    ...
    private function _track(WaterQualityArchiveContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
