...
// WaterQualityArchive SDK metrics feature
...
class WaterQualityArchiveMetricsFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _record(WaterQualityArchiveContext $ctx, bool $ok): void
    {
