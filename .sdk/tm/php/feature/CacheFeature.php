...
// WaterQualityArchive SDK cache feature
...
class WaterQualityArchiveCacheFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _through(WaterQualityArchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
