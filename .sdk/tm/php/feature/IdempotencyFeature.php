...
// WaterQualityArchive SDK idempotency feature
...
class WaterQualityArchiveIdempotencyFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _mutating(WaterQualityArchiveContext $ctx): bool
    {
