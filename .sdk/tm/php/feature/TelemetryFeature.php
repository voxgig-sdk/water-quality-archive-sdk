...
// WaterQualityArchive SDK telemetry feature
...
class WaterQualityArchiveTelemetryFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _close(WaterQualityArchiveContext $ctx, bool $ok): void
    {
