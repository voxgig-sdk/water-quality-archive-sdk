...
// WaterQualityArchive SDK utility: fetcher

class WaterQualityArchiveFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WaterQualityArchiveSDK/1.0)';
    ...
    public static function call(WaterQualityArchiveContext $ctx, string $fullurl, array $fetchdef): array
    {
