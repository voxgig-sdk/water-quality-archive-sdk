...
// WaterQualityArchive SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WaterQualityArchiveMakeRequest
{
    public static function call(WaterQualityArchiveContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WaterQualityArchiveResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WaterQualityArchiveResponse($fetched);
        } else {
