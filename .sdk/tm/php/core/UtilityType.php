...
// WaterQualityArchive SDK utility type

class WaterQualityArchiveUtility
{
    ...
    public static function copy(WaterQualityArchiveUtility $src): WaterQualityArchiveUtility
    {
        $u = new WaterQualityArchiveUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
