# WaterQualityArchive TypeScript SDK Reference

Complete API reference for the WaterQualityArchive TypeScript SDK.
...
```ts
new WaterQualityArchiveSDK(options?: object)
```
...
#### `WaterQualityArchiveSDK.test(testopts?, sdkopts?)`
...
**Returns:** `WaterQualityArchiveSDK` instance in test mode.
...
Alias for `WaterQualityArchiveSDK.test()`.
...
Return the parent `WaterQualityArchiveSDK` instance.
