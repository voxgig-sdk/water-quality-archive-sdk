...
The TypeScript SDK for the WaterQualityArchive API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new WaterQualityArchiveSDK({ apikey: '...' })
