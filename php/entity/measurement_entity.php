...
class MeasurementEntity
{
    ...
    {
        if ($args) {
            $this->_data = WaterQualityArchiveHelpers::to_map(Struct::clone($args)) ?? [];
    ...
    {
        if ($args) {
            $this->_match = WaterQualityArchiveHelpers::to_map(Struct::clone($args)) ?? [];
     ...
     *   the SDK boundary; throws WaterQualityArchiveError on failure (item-5 convention).
     */
