...
// WaterQualityArchive SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WaterQualityArchiveSDK::test)
...
{
    private const SDK_CLASS = 'WaterQualityArchiveSDK';
    ...
    private const SDK_BASE = 'waterqualityarchive_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../waterqualityarchive_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
