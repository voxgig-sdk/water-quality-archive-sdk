...
// WaterQualityArchive SDK pipeline test
//
...
{
    private static function utility(): WaterQualityArchiveUtility
    {
        return new WaterQualityArchiveUtility();
    }
    ...
    private static function ctx(array $over = []): WaterQualityArchiveContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WaterQualityArchiveContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WaterQualityArchiveError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WaterQualityArchiveMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WaterQualityArchiveMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WaterQualityArchiveMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaterQualityArchiveSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WaterQualityArchiveMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WaterQualityArchiveResponse([]),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        [, $err] = WaterQualityArchiveMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec([]),
            'response' => null,
            'result' => new WaterQualityArchiveResult([]),
        ]);
        [, $err] = WaterQualityArchiveMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec(['step' => 's']),
            'response' => new WaterQualityArchiveResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        [, $err] = WaterQualityArchiveMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec(['step' => 's']),
            'response' => new WaterQualityArchiveResponse(self::resp(200, ['v' => 1])),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        [, $err] = WaterQualityArchiveMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec(['step' => 's']),
            'response' => new WaterQualityArchiveResponse(self::resp(200, ['v' => 2])),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WaterQualityArchiveMakeResponse::call($ctx);
    ...
    {
        $preset = new WaterQualityArchiveResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec([]),
            'response' => new WaterQualityArchiveResponse([]),
            'result' => new WaterQualityArchiveResult([]),
        ...
        [$got, $err] = WaterQualityArchiveMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WaterQualityArchiveResult([])]);
        [, $err] = WaterQualityArchiveMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WaterQualityArchiveSpec([]), 'result' => null]);
        [, $err] = WaterQualityArchiveMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaterQualityArchiveSpec(['step' => 's']),
            'result' => new WaterQualityArchiveResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaterQualityArchiveMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaterQualityArchiveSpec(['step' => 's']),
            'result' => new WaterQualityArchiveResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WaterQualityArchiveOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaterQualityArchiveMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaterQualityArchiveResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WaterQualityArchiveSpec([]),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WaterQualityArchiveMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaterQualityArchiveMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WaterQualityArchiveError('boom', 'boom');
        $utility->fetcher = function (WaterQualityArchiveContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaterQualityArchiveSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WaterQualityArchiveMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WaterQualityArchiveContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WaterQualityArchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WaterQualityArchiveResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WaterQualityArchiveMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WaterQualityArchiveContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaterQualityArchiveSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WaterQualityArchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WaterQualityArchiveResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WaterQualityArchiveSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WaterQualityArchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WaterQualityArchiveMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WaterQualityArchiveMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WaterQualityArchiveResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WaterQualityArchiveDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WaterQualityArchiveResult(['ok' => false])]);
        $this->expectException(WaterQualityArchiveError::class);
        WaterQualityArchiveDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WaterQualityArchiveResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WaterQualityArchiveMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WaterQualityArchiveMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WaterQualityArchiveBaseFeature();
        $b = new WaterQualityArchiveBaseFeature();
        WaterQualityArchiveFeatureAdd::call($ctx, $a);
        WaterQualityArchiveFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WaterQualityArchiveBaseFeature
    {
        $f = new WaterQualityArchiveBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WaterQualityArchiveFeatureAdd::call($ctx, self::named_feature('a'));
        WaterQualityArchiveFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WaterQualityArchiveFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WaterQualityArchiveFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WaterQualityArchiveFeatureAdd::call($ctx, $replace);
        ...
        WaterQualityArchiveFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WaterQualityArchiveContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WaterQualityArchiveSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaterQualityArchivePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WaterQualityArchivePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WaterQualityArchiveResponse(['headers' => null]),
            'result' => new WaterQualityArchiveResult([]),
        ]);
        WaterQualityArchiveResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WaterQualityArchiveResultBody::call($ctx);
