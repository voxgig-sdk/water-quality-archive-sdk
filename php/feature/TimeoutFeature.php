...
// WaterQualityArchive SDK timeout feature
...
class WaterQualityArchiveTimeoutFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _with_timeout(WaterQualityArchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WaterQualityArchiveContext $_ctx, float $ms): void
    {
        $client = $this->client;
