...
// WaterQualityArchive SDK netsim feature
...
class WaterQualityArchiveNetsimFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _simulate(WaterQualityArchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WaterQualityArchiveContext $ctx, array $applied): void
    {
        $client = $this->client;
