...
// WaterQualityArchive SDK debug feature
...
class WaterQualityArchiveDebugFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _finish(WaterQualityArchiveContext $ctx, bool $ok): void
    {
