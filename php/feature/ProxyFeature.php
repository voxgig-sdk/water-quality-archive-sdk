...
// WaterQualityArchive SDK proxy feature
...
class WaterQualityArchiveProxyFeature extends WaterQualityArchiveBaseFeature
{
    ...
    public function init(WaterQualityArchiveContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WaterQualityArchiveContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
