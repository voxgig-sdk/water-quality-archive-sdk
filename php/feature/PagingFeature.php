...
// WaterQualityArchive SDK paging feature
...
class WaterQualityArchivePagingFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _is_list(WaterQualityArchiveContext $ctx): bool
    {
