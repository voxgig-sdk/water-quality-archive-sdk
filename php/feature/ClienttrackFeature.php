...
// WaterQualityArchive SDK clienttrack feature
...
class WaterQualityArchiveClienttrackFeature extends WaterQualityArchiveBaseFeature
{
    ...
    public function PostConstruct(WaterQualityArchiveContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WaterQualityArchive-SDK';
