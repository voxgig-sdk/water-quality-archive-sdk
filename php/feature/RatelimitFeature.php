...
// WaterQualityArchive SDK ratelimit feature
...
class WaterQualityArchiveRatelimitFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _acquire(WaterQualityArchiveContext $ctx): void
    {
    ...
    private function _track(WaterQualityArchiveContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
