...
// WaterQualityArchive SDK streaming feature
...
class WaterQualityArchiveStreamingFeature extends WaterQualityArchiveBaseFeature
{
    ...
    private function _iterate(WaterQualityArchiveResult $result): \Generator
    {
    ...
    private function _streamable(WaterQualityArchiveContext $ctx): bool
    {
