...
// WaterQualityArchive SDK utility: graphql
//
...
class WaterQualityArchiveGraphql
{
    ...
    // equivalent.
    public static function body(WaterQualityArchiveContext $ctx): mixed
    {
    ...
    public static function errors(WaterQualityArchiveContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
