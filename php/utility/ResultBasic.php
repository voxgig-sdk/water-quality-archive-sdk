...
// WaterQualityArchive SDK utility: result_basic

class WaterQualityArchiveResultBasic
{
    public static function call(WaterQualityArchiveContext $ctx): ?WaterQualityArchiveResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WaterQualityArchiveError) ? $result->err->msg : (string)$result->err;
