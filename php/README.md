...
The PHP SDK for the WaterQualityArchive API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Measurement(null)->list(null, null);
...
[$result, $err] = $client->WaterQualityArchive(null)->load(
    ["id" => "test01"], null
);
