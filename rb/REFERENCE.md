# WaterQualityArchive Ruby SDK Reference

Complete API reference for the WaterQualityArchive Ruby SDK.
...
```ruby
require_relative 'water-quality-archive_sdk'
...
#### `WaterQualityArchiveSDK.test(testopts = nil, sdkopts = nil)`
