# WaterQualityArchive SDK Measurement entity
...
class MeasurementEntity
  ...
  def data_set(args)
    if args
      @_data = WaterQualityArchiveHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = WaterQualityArchiveHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Measurement>, Array] the matching Measurement items; raises WaterQualityArchiveError on failure
