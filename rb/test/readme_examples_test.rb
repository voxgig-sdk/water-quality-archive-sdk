...
#      offline in seeded test mode (WaterQualityArchiveSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WaterQualityArchive_sdk.rb")
  SDK_CLASS = "WaterQualityArchiveSDK"
  ...
  SDK_BASE = "WaterQualityArchive_sdk"
