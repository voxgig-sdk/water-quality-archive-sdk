...
class MeasurementEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = WaterQualityArchiveSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WATER_QUALITY_ARCHIVE_TEST_MEASUREMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def measurement_basic_setup(extra)
  ...
  entid_env_raw = ENV["WATER_QUALITY_ARCHIVE_TEST_MEASUREMENT_ENTID"]
