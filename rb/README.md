...
The Ruby SDK for the WaterQualityArchive API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.WaterQualityArchive(nil).load(
  { "id" => "test01" }, nil
)
