...
func registerSDKWords(r *eng.Registry, client *sdk.WaterQualityArchiveSDK) {
...
func runOp(client *sdk.WaterQualityArchiveSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
