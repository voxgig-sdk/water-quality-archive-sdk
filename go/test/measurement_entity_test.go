...
func TestMeasurementEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set WATER_QUALITY_ARCHIVE_TEST_MEASUREMENT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func measurementBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WATER_QUALITY_ARCHIVE_TEST_MEASUREMENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["WATER_QUALITY_ARCHIVE_TEST_MEASUREMENT_ENTID"])
