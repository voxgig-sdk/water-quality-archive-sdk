# WaterQualityArchive Golang SDK Reference

Complete API reference for the WaterQualityArchive Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *WaterQualityArchiveSDK`
...
#### `Measurement(data map[string]any) WaterQualityArchiveEntity`
