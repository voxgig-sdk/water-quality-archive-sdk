...
// instead of `sdk.NewWaterQualityArchiveSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *WaterQualityArchiveSDK  { return NewWaterQualityArchiveSDK(nil) }
func Test() *WaterQualityArchiveSDK { return TestSDK(nil, nil) }
