...
type WaterQualityArchiveSDK struct {
	Mode     string
...
func (sdk *WaterQualityArchiveSDK) OptionsMap() map[string]any {
...
func (sdk *WaterQualityArchiveSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WaterQualityArchiveSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WaterQualityArchiveSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaterQualityArchiveSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WaterQualityArchiveSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WaterQualityArchiveSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WaterQualityArchiveSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WaterQualityArchiveSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaterQualityArchiveSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WaterQualityArchiveSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WaterQualityArchiveSDK {
	...
	sdk := NewWaterQualityArchiveSDK(sdkopts)
	sdk.Mode = "test"
